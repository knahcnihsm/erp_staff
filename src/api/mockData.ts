...
export const students: StudentSummary[] = [
  { studentId: 6, regNo: '24TD0064', name: 'Mohankumar S', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 8, regNo: '2026BTECH001', name: 'Student 1', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ARCHIVED' },
  { studentId: 11, regNo: '24TD0063', name: 'Student 2', department: 'Artificial Intelligence and Data Science (AI&DS)', deptShort: 'AI&DS', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 14, regNo: '24TP0074', name: 'Aarav Sharma', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 15, regNo: '24TP0073', name: 'Ananya', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
  { studentId: 16, regNo: '24TP0072', name: 'Rahul Varma', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 17, regNo: '24TP0071', name: 'Kavya Subramanian', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
  { studentId: 18, regNo: '24TP0070', name: 'Dhruv Patel', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 19, regNo: '24TP0069', name: 'Priya Sundaram', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
  { studentId: 20, regNo: '24TD0068', name: 'Vikramaditya Reddy', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 21, regNo: '24TD0067', name: 'Sneha Venkatesh', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
  { studentId: 22, regNo: '24TD0066', name: 'Karthik Nair', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 23, regNo: '24TD0065', name: 'Divya Iyer', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
  { studentId: 24, regNo: '24TD0062', name: 'Student 6', department: 'Biomedical Engineering (BME)', deptShort: 'BME', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 25, regNo: '24TD0061', name: 'Suresh Kumar R G', department: 'M.Tech Computer Science & Engineering (MTech CSE)', deptShort: 'MTech CSE', year: 3, section: 'A', status: 'ACTIVE' },
  { studentId: 28, regNo: '24TD0062', name: 'Mohan Kumar S', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
  { studentId: 29, regNo: '26BTECH012', name: 'Arun Kumar', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 30, regNo: '24TD0069', name: 'Meena Priya', department: 'Information Technology (IT)', deptShort: 'IT', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 31, regNo: '24TD0068', name: 'Rahul Prakash', department: 'Electronics & Communication Engineering (ECE)', deptShort: 'ECE', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 32, regNo: '24TD0067', name: 'Ananya Ramesh', department: 'Artificial Intelligence and Data Science (AI&DS)', deptShort: 'AI&DS', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 33, regNo: '24TD0066', name: 'Vishnu Raj', department: 'Artificial Intelligence and Machine Learning (AI&ML)', deptShort: 'AI&ML', year: 1, section: 'A', status: 'ACTIVE' },
  { studentId: 34, regNo: '24TD0065', name: 'Karthik Raj', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 2, section: 'A', status: 'ACTIVE' },
  { studentId: 35, regNo: '24TD0064', name: 'Nithya Devi', department: 'Electronics & Communication Engineering (ECE)', deptShort: 'ECE', year: 2, section: 'A', status: 'ACTIVE' },
  { studentId: 36, regNo: '24TD0063', name: 'Sanjay Mohan', department: 'Biomedical Engineering (BME)', deptShort: 'BME', year: 2, section: 'A', status: 'ACTIVE' },
  { studentId: 37, regNo: '24TD0062', name: 'Priyanka Suresh', department: 'Master of Computer Applications (MCA)', deptShort: 'MCA', year: 3, section: 'A', status: 'ACTIVE' },
  { studentId: 38, regNo: '24TD0061', name: 'Aravind Kumar', department: 'M.Tech Computer Science & Engineering (MTech CSE)', deptShort: 'MTech CSE', year: 3, section: 'A', status: 'ACTIVE' },
  { studentId: 39, regNo: '24TD0060', name: 'Akash', department: 'Computer Science & Engineering (CSE)', deptShort: 'CSE', year: 1, section: 'B', status: 'ACTIVE' },
];
...
export const semesterGpaData: SemesterGpa[] = [
  { gpaId: 101, studentId: 6, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.5 },
  { gpaId: 102, studentId: 6, semesterNumber: 2, academicYear: '2026-27', semesterGpa: 8.7 },
  { gpaId: 103, studentId: 14, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 9.2 },
  { gpaId: 104, studentId: 14, semesterNumber: 2, academicYear: '2026-27', semesterGpa: 9.1 },
  { gpaId: 105, studentId: 29, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.9 },
  { gpaId: 106, studentId: 29, semesterNumber: 2, academicYear: '2026-27', semesterGpa: 8.5 },
  { gpaId: 107, studentId: 34, semesterNumber: 1, academicYear: '2025-26', semesterGpa: 8.2 },
  { gpaId: 108, studentId: 34, semesterNumber: 2, academicYear: '2025-26', semesterGpa: 7.6 },
  { gpaId: 109, studentId: 34, semesterNumber: 3, academicYear: '2026-27', semesterGpa: 7.9 },
  { gpaId: 110, studentId: 35, semesterNumber: 1, academicYear: '2025-26', semesterGpa: 8.8 },
  { gpaId: 111, studentId: 35, semesterNumber: 2, academicYear: '2025-26', semesterGpa: 8.1 },
  { gpaId: 112, studentId: 37, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.4 },
  { gpaId: 113, studentId: 37, semesterNumber: 2, academicYear: '2026-27', semesterGpa: 8.8 },
  { gpaId: 114, studentId: 38, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 9.0 },
  { gpaId: 115, studentId: 28, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.1 },
  { gpaId: 116, studentId: 30, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 7.4 },
  { gpaId: 117, studentId: 31, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.6 },
  { gpaId: 118, studentId: 32, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.3 },
  { gpaId: 119, studentId: 33, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.8 },
  { gpaId: 120, studentId: 25, semesterNumber: 1, academicYear: '2026-27', semesterGpa: 8.7 },
];

export const yearCgpaData: YearCgpa[] = [
  { cgpaId: 201, studentId: 6, yearNumber: 1, academicYear: '2026-27', cgpa: 8.6 },
  { cgpaId: 202, studentId: 14, yearNumber: 1, academicYear: '2026-27', cgpa: 9.15 },
  { cgpaId: 203, studentId: 29, yearNumber: 1, academicYear: '2026-27', cgpa: 8.7 },
  { cgpaId: 204, studentId: 34, yearNumber: 1, academicYear: '2025-26', cgpa: 7.9 },
  { cgpaId: 205, studentId: 35, yearNumber: 1, academicYear: '2025-26', cgpa: 8.45 },
  { cgpaId: 206, studentId: 37, yearNumber: 1, academicYear: '2026-27', cgpa: 8.6 },
  { cgpaId: 207, studentId: 38, yearNumber: 1, academicYear: '2026-27', cgpa: 9.0 },
  { cgpaId: 208, studentId: 28, yearNumber: 1, academicYear: '2026-27', cgpa: 8.1 },
  { cgpaId: 209, studentId: 30, yearNumber: 1, academicYear: '2026-27', cgpa: 7.4 },
  { cgpaId: 210, studentId: 31, yearNumber: 1, academicYear: '2026-27', cgpa: 8.6 },
  { cgpaId: 211, studentId: 32, yearNumber: 1, academicYear: '2026-27', cgpa: 8.3 },
  { cgpaId: 212, studentId: 33, yearNumber: 1, academicYear: '2026-27', cgpa: 8.8 },
  { cgpaId: 213, studentId: 25, yearNumber: 1, academicYear: '2026-27', cgpa: 8.7 },
];
